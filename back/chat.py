...
from template import templates, models
from utils import message_to_dict, dict_to_message


def create_chat(username, chat_name, template, model):
    initial_message = AIMessage(content="Bonjour, comment puis-je t'aider ?")
    new_chat = {
        "chat_name": chat_name,
